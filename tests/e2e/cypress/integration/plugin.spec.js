describe("Plugin", () => {
  ...
  it.skip("Should show an error message that the plugin needs to be network activated", () => {
    cy.visit("/wp-admin/");
  ...
  it("Should be able to activate the plugin", () => {
    ...
    cy.get("#activate-wp-multisite-waas").scrollIntoView().should("be.visible").click();
