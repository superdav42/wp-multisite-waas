...
One of the most immediate decisions you will need to make is whether the multisite installation will operate with _subdirectories_ or _subdomains_. WP Ultimo works equally well with both choices but there are some architectural differences between the two configurations.
