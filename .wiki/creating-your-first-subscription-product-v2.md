...
_**IMPORTANT NOTE: This article is only for WP Ultimo version 2.x users. If you are using version 1.x,**_ [_**see this article**_](https://help.wpultimo.com/article/268-getting-started-with-new-plans).
