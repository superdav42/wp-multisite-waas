...
class Post_Base_Model extends Base_Model {
	...
	public function load_attributes_from_post() {
		...
		if (isset($_POST['content'])) { // phpcs:ignore WordPress.Security.NonceVerification
			$this->set_content(sanitize_post_field('content', wp_unslash($_POST['content']), $this->get_id(), 'edit')); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification
		}
